...
--
-- Name: insert_random_products(integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.insert_random_products(IN counter integer)
    LANGUAGE plpgsql
    AS $$
DECLARE 
    i INTEGER := 1;
...
ALTER PROCEDURE public.insert_random_products(IN counter integer) OWNER TO postgres;

--
-- Name: insert_random_user(integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.insert_random_user(IN count integer)
    LANGUAGE plpgsql
    AS $$
    DECLARE 
       i INTEGER := 1;
...
ALTER PROCEDURE public.insert_random_user(IN count integer) OWNER TO postgres;
...
--
-- Name: store_dummy_data_generator(integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.store_dummy_data_generator(IN count integer)
    LANGUAGE plpgsql
    AS $$ 
  DECLARE
      i INTEGER := 1;
...
BEGIN 
    WHILE i <= count LOOP
        ...
        INSERT INTO store (id_user,name,description,store_type) VALUES(1,store_name,store_description,store_choice);
        i := i + 1;
    END LOOP; 
END;
$$;
...
ALTER PROCEDURE public.store_dummy_data_generator(IN count integer) OWNER TO postgres;
...
--
-- Name: bought_ticket; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.bought_ticket (
    id integer NOT NULL,
    id_user integer,
    id_ticket integer,
    total_ticket integer,
    created timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    on_update timestamp with time zone,
    CONSTRAINT bought_ticket_total_ticket_check CHECK ((total_ticket > 0))
);


ALTER TABLE public.bought_ticket OWNER TO postgres;

--
-- Name: bought_ticket_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.bought_ticket ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.bought_ticket_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: browsing_history; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: browsing_history_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.browsing_history ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.browsing_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bundle_deal; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.bundle_deal (
    id integer NOT NULL,
    id_store integer,
...
ALTER TABLE public.bundle_deal OWNER TO postgres;

--
-- Name: bundle_deal_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.bundle_deal ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.bundle_deal_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bundle_deal_item; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.bundle_deal_item (
    id integer NOT NULL,
...
ALTER TABLE public.bundle_deal_item OWNER TO postgres;

--
-- Name: bundle_deal_item_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.bundle_deal_item ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.bundle_deal_item_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.chat_room (
    ...
    link_expiry_duration timestamp with time zone NOT NULL,
    is_link_private boolean DEFAULT false
);
...
--
-- Name: chat_room_member_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.chat_room_member ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.chat_room_member_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.gift ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.gift_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: group_order; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.group_order OWNER TO postgres;

--
-- Name: group_order_delivery_address; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.group_order_delivery_address (
    id integer NOT NULL,
...
ALTER TABLE public.group_order_delivery_address OWNER TO postgres;

--
-- Name: group_order_delivery_address_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.group_order_delivery_address ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.group_order_delivery_address_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: group_order_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.group_order ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.group_order_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: grouporder_order; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.grouporder_order (
    id integer NOT NULL,
    id_order integer,
    id_group_order integer,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
...
ALTER TABLE public.grouporder_order OWNER TO postgres;

--
-- Name: grouporder_order_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.grouporder_order ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.grouporder_order_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: inventory_specification; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.inventory_specification (
    id integer NOT NULL,
...
ALTER TABLE public.inventory_specification OWNER TO postgres;

--
-- Name: inventory_specification_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.inventory_specification ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.inventory_specification_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: lukup_refund_reason; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.lukup_refund_reason (
    id integer NOT NULL,
    reason character varying(255) NOT NULL
);


ALTER TABLE public.lukup_refund_reason OWNER TO postgres;

--
-- Name: lukup_refund_reason_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.lukup_refund_reason ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.lukup_refund_reason_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: lukup_refund_type; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.lukup_refund_type (
    id integer NOT NULL,
    refund_type smallint NOT NULL
);


ALTER TABLE public.lukup_refund_type OWNER TO postgres;

--
-- Name: lukup_refund_type_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.lukup_refund_type ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.lukup_refund_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: lukup_specification_category; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.lukup_specification_category (
    id integer NOT NULL,
...
ALTER TABLE public.lukup_specification_category OWNER TO postgres;

--
-- Name: lukup_specification_category_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.lukup_specification_category ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.lukup_specification_category_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: product_refund_request; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.product_refund_request (
    id integer NOT NULL,
    id_order integer,
...
ALTER TABLE public.product_refund_request OWNER TO postgres;

--
-- Name: product_refund_request_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.product_refund_request ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.product_refund_request_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: registered_subscribers; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.registered_subscribers (
    id integer NOT NULL,
...
ALTER TABLE public.registered_subscribers OWNER TO postgres;

--
-- Name: registered_subscribers_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.registered_subscribers ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.registered_subscribers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: registered_user_for_event; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.registered_user_for_event (
    id integer NOT NULL,
    id_event integer,
...
ALTER TABLE public.registered_user_for_event OWNER TO postgres;

--
-- Name: registered_user_for_event_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.registered_user_for_event ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.registered_user_for_event_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: saved_search_filter_preference; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.saved_search_filter_preference (
    id integer NOT NULL,
    id_user integer,
...
ALTER TABLE public.saved_search_filter_preference OWNER TO postgres;

--
-- Name: saved_search_filter_preference_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.saved_search_filter_preference ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.saved_search_filter_preference_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: saved_search_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.saved_search ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.saved_search_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: saved_seller; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.saved_seller (
    id integer NOT NULL,
    id_user integer,
    id_store integer,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
ALTER TABLE public.saved_seller OWNER TO postgres;

--
-- Name: saved_seller_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.saved_seller ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.saved_seller_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: subscription_duration; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.subscription_duration OWNER TO postgres;

--
-- Name: subscription_duration_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.subscription_duration ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.subscription_duration_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ticket_transfer; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ticket_transfer OWNER TO postgres;

--
-- Name: ticket_transfer_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.ticket_transfer ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.ticket_transfer_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_size_pref; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.user_size_pref (
    id integer NOT NULL,
    id_user integer,
    product_type smallint NOT NULL,
    size_value numeric(3,1) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.user_size_pref OWNER TO postgres;

--
-- Name: user_size_pref_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.user_size_pref ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.user_size_pref_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.wishlist_item ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: wishlist_notification; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.wishlist_notification (
    id integer NOT NULL,
...
ALTER TABLE public.wishlist_notification OWNER TO postgres;

--
-- Name: wishlist_notification_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.wishlist_notification ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.wishlist_notification_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bought_ticket bought_ticket_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bought_ticket
    ADD CONSTRAINT bought_ticket_pkey PRIMARY KEY (id);
...
--
-- Name: browsing_history browsing_history_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: bundle_deal_item bundle_deal_item_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bundle_deal_item
    ADD CONSTRAINT bundle_deal_item_pkey PRIMARY KEY (id);


--
-- Name: bundle_deal bundle_deal_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bundle_deal
    ADD CONSTRAINT bundle_deal_pkey PRIMARY KEY (id);
...
--
-- Name: group_order_delivery_address group_order_delivery_address_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.group_order_delivery_address
    ADD CONSTRAINT group_order_delivery_address_pkey PRIMARY KEY (id);


--
-- Name: group_order group_order_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.group_order
    ADD CONSTRAINT group_order_pkey PRIMARY KEY (id);


--
-- Name: grouporder_order grouporder_order_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.grouporder_order
    ADD CONSTRAINT grouporder_order_pkey PRIMARY KEY (id);
...
--
-- Name: inventory_specification inventory_specification_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.inventory_specification
    ADD CONSTRAINT inventory_specification_pkey PRIMARY KEY (id);
...
--
-- Name: lukup_refund_reason lukup_refund_reason_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lukup_refund_reason
    ADD CONSTRAINT lukup_refund_reason_pkey PRIMARY KEY (id);


--
-- Name: lukup_refund_type lukup_refund_type_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lukup_refund_type
    ADD CONSTRAINT lukup_refund_type_pkey PRIMARY KEY (id);
...
--
-- Name: lukup_specification_category lukup_specification_category_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lukup_specification_category
    ADD CONSTRAINT lukup_specification_category_pkey PRIMARY KEY (id);
...
--
-- Name: product_refund_request product_refund_request_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_refund_request
    ADD CONSTRAINT product_refund_request_pkey PRIMARY KEY (id);
...
--
-- Name: product product_unique_name; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: registered_subscribers registered_subscribers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registered_subscribers
    ADD CONSTRAINT registered_subscribers_pkey PRIMARY KEY (id);


--
-- Name: registered_user_for_event registered_user_for_event_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registered_user_for_event
    ADD CONSTRAINT registered_user_for_event_pkey PRIMARY KEY (id);
...
--
-- Name: saved_search_filter_preference saved_search_filter_preference_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.saved_search_filter_preference
    ADD CONSTRAINT saved_search_filter_preference_pkey PRIMARY KEY (id);


--
-- Name: saved_search saved_search_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: saved_seller saved_seller_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.saved_seller
    ADD CONSTRAINT saved_seller_pkey PRIMARY KEY (id);
...
--
-- Name: subscription_duration subscription_duration_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subscription_duration
    ADD CONSTRAINT subscription_duration_pkey PRIMARY KEY (id);
...
--
-- Name: ticket_transfer ticket_transfer_barcode_image_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_transfer
    ADD CONSTRAINT ticket_transfer_barcode_image_key UNIQUE (barcode_image);


--
-- Name: ticket_transfer ticket_transfer_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.user_roles
    ADD CONSTRAINT user_roles_pkey PRIMARY KEY (id_role, id_user);


--
-- Name: user_size_pref user_size_pref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_size_pref
    ADD CONSTRAINT user_size_pref_pkey PRIMARY KEY (id);
...
--
-- Name: wishlist_notification wishlist_notification_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wishlist_notification
    ADD CONSTRAINT wishlist_notification_pkey PRIMARY KEY (id);
...
--
-- Name: idx_geom_location_goda; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_geom_location_goda ON public.group_order_delivery_address USING gist (geom_location);
...
--
-- Name: idx_product_name_gin; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_product_name_gin ON public.product USING gin (name public.gin_trgm_ops);
...
--
-- Name: bought_ticket bought_ticket_id_ticket_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bought_ticket
    ADD CONSTRAINT bought_ticket_id_ticket_fkey FOREIGN KEY (id_ticket) REFERENCES public.ticket_type(id) ON UPDATE CASCADE;


--
-- Name: bought_ticket bought_ticket_id_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bought_ticket
    ADD CONSTRAINT bought_ticket_id_user_fkey FOREIGN KEY (id_user) REFERENCES public."user"(id) ON UPDATE CASCADE;


--
-- Name: bundle_deal bundle_deal_id_store_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bundle_deal
    ADD CONSTRAINT bundle_deal_id_store_fkey FOREIGN KEY (id_store) REFERENCES public.store(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: bundle_deal_item bundle_deal_item_id_bundle_deal_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bundle_deal_item
    ADD CONSTRAINT bundle_deal_item_id_bundle_deal_fkey FOREIGN KEY (id_bundle_deal) REFERENCES public.bundle_deal(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: bundle_deal_item bundle_deal_item_id_product_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bundle_deal_item
    ADD CONSTRAINT bundle_deal_item_id_product_fkey FOREIGN KEY (id_product) REFERENCES public.inventory(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: chat_room_member chat_room_member_id_chat_room_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chat_room_member
    ADD CONSTRAINT chat_room_member_id_chat_room_fkey FOREIGN KEY (id_chat_room) REFERENCES public.chat_room(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: chat_room_member chat_room_member_id_member_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chat_room_member
    ADD CONSTRAINT chat_room_member_id_member_fkey FOREIGN KEY (id_member) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: refund fk_approver; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.refund
    ADD CONSTRAINT fk_approver FOREIGN KEY (id_approver) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: store_location fk_id_district; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.store_location
    ADD CONSTRAINT fk_id_district FOREIGN KEY (id_district) REFERENCES public.districts(id) ON UPDATE CASCADE;


--
-- Name: chat_single fk_id_sender; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chat_single
    ADD CONSTRAINT fk_id_sender FOREIGN KEY (id_sender) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: store fk_id_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.store
    ADD CONSTRAINT fk_id_user FOREIGN KEY (id_user) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: user_permission_entity fk_id_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_permission_entity
    ADD CONSTRAINT fk_id_user FOREIGN KEY (id_user) REFERENCES public."user"(id) ON UPDATE CASCADE;


--
-- Name: product fk_product_catag; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product
    ADD CONSTRAINT fk_product_catag FOREIGN KEY (category) REFERENCES public.lukup_category(id);


--
-- Name: user_size_pref fk_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_size_pref
    ADD CONSTRAINT fk_user FOREIGN KEY (id_user) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: gift gift_id_order_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.gift
    ADD CONSTRAINT gift_id_order_fkey FOREIGN KEY (id_order) REFERENCES public."order"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: gift gift_id_recipient_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.gift
    ADD CONSTRAINT gift_id_recipient_fkey FOREIGN KEY (id_recipient) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: group_order_delivery_address group_order_delivery_address_id_group_order_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.group_order_delivery_address
    ADD CONSTRAINT group_order_delivery_address_id_group_order_fkey FOREIGN KEY (id_group_order) REFERENCES public.group_order(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: group_order group_order_id_organizer_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.group_order
    ADD CONSTRAINT group_order_id_organizer_fkey FOREIGN KEY (id_organizer) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: inventory_specification inventory_specification_id_category_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.inventory_specification
    ADD CONSTRAINT inventory_specification_id_category_fkey FOREIGN KEY (id_category) REFERENCES public.lukup_category(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: inventory_specification inventory_specification_id_inventory_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.inventory_specification
    ADD CONSTRAINT inventory_specification_id_inventory_fkey FOREIGN KEY (id_inventory) REFERENCES public.inventory(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: lukup_specification_category lukup_specification_category_id_applicable_category_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lukup_specification_category
    ADD CONSTRAINT lukup_specification_category_id_applicable_category_fkey FOREIGN KEY (id_applicable_category) REFERENCES public.lukup_category(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: lukup_specification_category lukup_specification_category_id_lukup_specification_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lukup_specification_category
    ADD CONSTRAINT lukup_specification_category_id_lukup_specification_fkey FOREIGN KEY (id_lukup_specification) REFERENCES public.lukup_specification(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: product_refund_request product_refund_request_id_order_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_refund_request
    ADD CONSTRAINT product_refund_request_id_order_fkey FOREIGN KEY (id_order) REFERENCES public."order"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: product_refund_request product_refund_request_id_refund_checker_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_refund_request
    ADD CONSTRAINT product_refund_request_id_refund_checker_fkey FOREIGN KEY (id_refund_checker) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: product_refund_request product_refund_request_id_refund_reason_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_refund_request
    ADD CONSTRAINT product_refund_request_id_refund_reason_fkey FOREIGN KEY (id_refund_reason) REFERENCES public.lukup_refund_reason(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: product_refund_request product_refund_request_id_refund_type_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_refund_request
    ADD CONSTRAINT product_refund_request_id_refund_type_fkey FOREIGN KEY (id_refund_type) REFERENCES public.lukup_refund_type(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: registered_subscribers registered_subscribers_id_subscriber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registered_subscribers
    ADD CONSTRAINT registered_subscribers_id_subscriber_fkey FOREIGN KEY (id_subscriber) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: registered_subscribers registered_subscribers_id_subscription_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registered_subscribers
    ADD CONSTRAINT registered_subscribers_id_subscription_fkey FOREIGN KEY (id_subscription) REFERENCES public.subscription(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: registered_user_for_event registered_user_for_event_id_event_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registered_user_for_event
    ADD CONSTRAINT registered_user_for_event_id_event_fkey FOREIGN KEY (id_event) REFERENCES public.event(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: saved_search_filter_preference saved_search_filter_preference_id_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.saved_search_filter_preference
    ADD CONSTRAINT saved_search_filter_preference_id_user_fkey FOREIGN KEY (id_user) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: saved_search saved_search_id_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.saved_search
    ADD CONSTRAINT saved_search_id_user_fkey FOREIGN KEY (id_user) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: saved_seller saved_seller_id_store_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.saved_seller
    ADD CONSTRAINT saved_seller_id_store_fkey FOREIGN KEY (id_store) REFERENCES public.store(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: saved_seller saved_seller_id_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.saved_seller
    ADD CONSTRAINT saved_seller_id_user_fkey FOREIGN KEY (id_user) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: subscription_duration subscription_duration_id_subscription_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subscription_duration
    ADD CONSTRAINT subscription_duration_id_subscription_fkey FOREIGN KEY (id_subscription) REFERENCES public.subscription(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: subscription subscription_id_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subscription
    ADD CONSTRAINT subscription_id_user_fkey FOREIGN KEY (id_user) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: ticket_transfer ticket_transfer_id_event_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ticket_transfer
    ADD CONSTRAINT ticket_transfer_id_event_fkey FOREIGN KEY (id_event) REFERENCES public.event(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: wishlist wishlist_id_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wishlist
    ADD CONSTRAINT wishlist_id_user_fkey FOREIGN KEY (id_user) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: wishlist_item wishlist_item_id_product_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wishlist_item
    ADD CONSTRAINT wishlist_item_id_product_fkey FOREIGN KEY (id_product) REFERENCES public.inventory(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: wishlist_item wishlist_item_id_wishlist_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wishlist_item
    ADD CONSTRAINT wishlist_item_id_wishlist_fkey FOREIGN KEY (id_wishlist) REFERENCES public.wishlist(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: wishlist_notification wishlist_notification_id_wishlist_item_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wishlist_notification
    ADD CONSTRAINT wishlist_notification_id_wishlist_item_fkey FOREIGN KEY (id_wishlist_item) REFERENCES public.wishlist_item(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: TABLE add_to_watchlist; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.add_to_watchlist TO emanuel1;


--
-- Name: TABLE auction; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.auction TO emanuel1;
...
GRANT ALL ON TABLE public.author TO emanuel1;
...
GRANT ALL ON TABLE public.authtoken_token TO emanuel1;


--
-- Name: TABLE auto_bid; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.auto_bid TO emanuel1;
...
GRANT ALL ON TABLE public.bid TO emanuel1;
...
GRANT ALL ON TABLE public.billing_addresses TO emanuel1;


--
-- Name: TABLE book_detail; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.book_detail TO emanuel1;


--
-- Name: TABLE book_inventory; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.book_inventory TO emanuel1;


--
-- Name: TABLE book_media; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.book_media TO emanuel1;


--
-- Name: TABLE book_promo_code; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.book_promo_code TO emanuel1;


--
-- Name: TABLE book_review; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.book_review TO emanuel1;


--
-- Name: TABLE bought_ticket; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.bought_ticket TO emanuel1;
...
GRANT ALL ON TABLE public.brand TO emanuel1;


--
-- Name: TABLE browsing_history; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.browsing_history TO emanuel1;


--
-- Name: TABLE bundle_deal; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.bundle_deal TO emanuel1;


--
-- Name: TABLE bundle_deal_item; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.bundle_deal_item TO emanuel1;


--
-- Name: TABLE buy_now_price; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.buy_now_price TO emanuel1;


--
-- Name: TABLE caching_expiry_setting; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.caching_expiry_setting TO emanuel1;


--
-- Name: TABLE caching_feature; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.caching_feature TO emanuel1;


--
-- Name: TABLE caching_setting; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.caching_setting TO emanuel1;


--
-- Name: TABLE caching_settings_detail; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.caching_settings_detail TO emanuel1;


--
-- Name: TABLE caching_type; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.caching_type TO emanuel1;


--
-- Name: TABLE capacity_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.capacity_spec TO emanuel1;


--
-- Name: TABLE capacity_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.capacity_spec_product TO emanuel1;
...
GRANT ALL ON TABLE public.cart TO emanuel1;


--
-- Name: TABLE chat_media_store; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.chat_media_store TO emanuel1;


--
-- Name: TABLE chat_room; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.chat_room TO emanuel1;


--
-- Name: TABLE chat_room_media; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.chat_room_media TO emanuel1;


--
-- Name: TABLE chat_room_member; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.chat_room_member TO emanuel1;


--
-- Name: TABLE chat_single; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.chat_single TO emanuel1;
...
GRANT ALL ON TABLE public.city TO emanuel1;


--
-- Name: TABLE clerks; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.clerks TO emanuel1;


--
-- Name: TABLE color_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.color_spec TO emanuel1;


--
-- Name: TABLE common_specification; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.common_specification TO emanuel1;
...
GRANT ALL ON TABLE public.complaint TO emanuel1;


--
-- Name: TABLE components_included_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.components_included_spec TO emanuel1;


--
-- Name: TABLE components_included_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.components_included_spec_product TO emanuel1;
...
GRANT ALL ON TABLE public.country TO emanuel1;


--
-- Name: TABLE cuisine_type; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.cuisine_type TO emanuel1;


--
-- Name: TABLE customer_return_request; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.customer_return_request TO emanuel1;


--
-- Name: TABLE customer_service_request; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.customer_service_request TO emanuel1;


--
-- Name: TABLE delivery_option; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.delivery_option TO emanuel1;


--
-- Name: TABLE delivery_person; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.delivery_person TO emanuel1;


--
-- Name: TABLE delivery_person_review; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.delivery_person_review TO emanuel1;
...
GRANT ALL ON TABLE public.delivery_status TO emanuel1;


--
-- Name: TABLE dish_drink_and_extra; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.dish_drink_and_extra TO emanuel1;


--
-- Name: TABLE dish_meal; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.dish_meal TO emanuel1;


--
-- Name: TABLE dish_rating; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.dish_rating TO emanuel1;
...
GRANT ALL ON TABLE public.districts TO emanuel1;


--
-- Name: TABLE driver_complaint; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.driver_complaint TO emanuel1;
...
GRANT ALL ON TABLE public.event TO emanuel1;


--
-- Name: TABLE event_activity_type; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.event_activity_type TO emanuel1;


--
-- Name: TABLE event_follower; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.event_follower TO emanuel1;
...
GRANT ALL ON TABLE public.event_media TO emanuel1;
...
GRANT ALL ON TABLE public.event_staff TO emanuel1;
...
GRANT ALL ON TABLE public.event_tags TO emanuel1;


--
-- Name: TABLE favorite_store; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.favorite_store TO emanuel1;


--
-- Name: TABLE features_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.features_spec TO emanuel1;


--
-- Name: TABLE features_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.features_spec_product TO emanuel1;


--
-- Name: TABLE finish_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.finish_spec TO emanuel1;


--
-- Name: TABLE finish_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.finish_spec_product TO emanuel1;


--
-- Name: TABLE food_compatibility_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.food_compatibility_spec TO emanuel1;


--
-- Name: TABLE food_compatibility_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.food_compatibility_spec_product TO emanuel1;


--
-- Name: TABLE fullfillment_type; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.fullfillment_type TO emanuel1;
...
GRANT ALL ON TABLE public.geography_columns TO emanuel1;
...
GRANT ALL ON TABLE public.geometry_columns TO emanuel1;


--
-- Name: TABLE gift; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.gift TO emanuel1;


--
-- Name: TABLE group_order; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.group_order TO emanuel1;


--
-- Name: TABLE group_order_delivery_address; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.group_order_delivery_address TO emanuel1;


--
-- Name: TABLE grouporder_order; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.grouporder_order TO emanuel1;
...
GRANT ALL ON TABLE public.inventory TO emanuel1;


--
-- Name: TABLE inventory_bulletlist; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.inventory_bulletlist TO emanuel1;


--
-- Name: TABLE inventory_specification; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.inventory_specification TO emanuel1;


--
-- Name: TABLE latest_deal; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.latest_deal TO emanuel1;
...
GRANT ALL ON TABLE public.lukup_category TO emanuel1;


--
-- Name: TABLE lukup_category_specification; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_category_specification TO emanuel1;


--
-- Name: TABLE lukup_complaint_category; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_complaint_category TO emanuel1;


--
-- Name: TABLE lukup_complaint_reason; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_complaint_reason TO emanuel1;


--
-- Name: TABLE lukup_dietary_tag; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_dietary_tag TO emanuel1;


--
-- Name: TABLE lukup_event_activity_type; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_event_activity_type TO emanuel1;


--
-- Name: TABLE lukup_event_category; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_event_category TO emanuel1;


--
-- Name: TABLE lukup_product_specification; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_product_specification TO emanuel1;


--
-- Name: TABLE lukup_refund_reason; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_refund_reason TO emanuel1;


--
-- Name: TABLE lukup_refund_type; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_refund_type TO emanuel1;


--
-- Name: TABLE lukup_report_metric; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_report_metric TO emanuel1;


--
-- Name: TABLE lukup_restauranct_cafe_category; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_restauranct_cafe_category TO emanuel1;


--
-- Name: TABLE lukup_return_reason; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_return_reason TO emanuel1;


--
-- Name: TABLE lukup_sauce; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_sauce TO emanuel1;


--
-- Name: TABLE lukup_service_type; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_service_type TO emanuel1;


--
-- Name: TABLE lukup_specification; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_specification TO emanuel1;


--
-- Name: TABLE lukup_specification_category; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_specification_category TO emanuel1;


--
-- Name: TABLE lukup_topping; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lukup_topping TO emanuel1;


--
-- Name: TABLE material_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.material_spec TO emanuel1;


--
-- Name: TABLE material_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.material_spec_product TO emanuel1;


--
-- Name: TABLE media_store; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.media_store TO emanuel1;


--
-- Name: TABLE media_url; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.media_url TO emanuel1;


--
-- Name: TABLE media_user; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.media_user TO emanuel1;


--
-- Name: TABLE message_text; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.message_text TO emanuel1;


--
-- Name: TABLE num_of_door_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.num_of_door_spec TO emanuel1;


--
-- Name: TABLE num_of_door_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.num_of_door_spec_product TO emanuel1;


--
-- Name: TABLE num_of_drawer_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.num_of_drawer_spec TO emanuel1;


--
-- Name: TABLE num_of_drawer_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.num_of_drawer_spec_product TO emanuel1;


--
-- Name: TABLE num_of_shelve_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.num_of_shelve_spec TO emanuel1;


--
-- Name: TABLE num_of_shelve_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.num_of_shelve_spec_product TO emanuel1;
...
GRANT ALL ON TABLE public.offer TO emanuel1;
...
GRANT ALL ON TABLE public."order" TO emanuel1;


--
-- Name: TABLE order_delivery_address; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.order_delivery_address TO emanuel1;
...
GRANT ALL ON TABLE public.order_item TO emanuel1;
...
GRANT ALL ON TABLE public.order_status TO emanuel1;


--
-- Name: TABLE organizer; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.organizer TO emanuel1;


--
-- Name: TABLE organizer_follower; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.organizer_follower TO emanuel1;


--
-- Name: TABLE other_complaint; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.other_complaint TO emanuel1;
...
GRANT ALL ON TABLE public.payment_method TO emanuel1;


--
-- Name: TABLE power_source_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.power_source_spec TO emanuel1;


--
-- Name: TABLE power_source_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.power_source_spec_product TO emanuel1;


--
-- Name: TABLE prime_service; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.prime_service TO emanuel1;


--
-- Name: TABLE prime_service_user; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.prime_service_user TO emanuel1;


--
-- Name: TABLE proc_lukup_event_category; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.proc_lukup_event_category TO emanuel1;
...
GRANT ALL ON TABLE public.product TO emanuel1;


--
-- Name: TABLE product_complaint; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.product_complaint TO emanuel1;


--
-- Name: TABLE product_refund_request; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.product_refund_request TO emanuel1;


--
-- Name: TABLE product_sanction; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.product_sanction TO emanuel1;
...
GRANT ALL ON TABLE public.refund TO emanuel1;


--
-- Name: TABLE registered_subscribers; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.registered_subscribers TO emanuel1;


--
-- Name: TABLE registered_user_for_event; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.registered_user_for_event TO emanuel1;


--
-- Name: TABLE regulatory_sanction; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.regulatory_sanction TO emanuel1;
...
GRANT ALL ON TABLE public.report TO emanuel1;


--
-- Name: TABLE request_throttle; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.request_throttle TO emanuel1;


--
-- Name: TABLE restaurant_cafe; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.restaurant_cafe TO emanuel1;
...
GRANT ALL ON TABLE public.return_reason TO emanuel1;
...
GRANT ALL ON TABLE public.roles TO emanuel1;


--
-- Name: TABLE sales_header; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.sales_header TO emanuel1;


--
-- Name: TABLE sauce_price; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.sauce_price TO emanuel1;


--
-- Name: TABLE saved_search; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.saved_search TO emanuel1;


--
-- Name: TABLE saved_search_filter_preference; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.saved_search_filter_preference TO emanuel1;


--
-- Name: TABLE saved_seller; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.saved_seller TO emanuel1;


--
-- Name: TABLE saved_store; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.saved_store TO emanuel1;


--
-- Name: TABLE search_key_inventory; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.search_key_inventory TO emanuel1;


--
-- Name: TABLE securitysettings; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.securitysettings TO emanuel1;
...
GRANT ALL ON TABLE public.seller TO emanuel1;
...
GRANT ALL ON TABLE public.service_request TO emanuel1;
...
GRANT ALL ON TABLE public.session TO emanuel1;


--
-- Name: TABLE shipping_address; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.shipping_address TO emanuel1;


--
-- Name: TABLE smart_home_protocol_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.smart_home_protocol_spec TO emanuel1;


--
-- Name: TABLE smart_home_protocol_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.smart_home_protocol_spec_product TO emanuel1;
...
GRANT ALL ON TABLE public.spatial_ref_sys TO emanuel1;
...
GRANT ALL ON TABLE public.states TO emanuel1;
...
GRANT ALL ON TABLE public.status TO emanuel1;
...
GRANT ALL ON TABLE public.store TO emanuel1;


--
-- Name: TABLE store_accessiblity; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.store_accessiblity TO emanuel1;


--
-- Name: TABLE store_complaint; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.store_complaint TO emanuel1;


--
-- Name: TABLE store_detail; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.store_detail TO emanuel1;


--
-- Name: TABLE store_fullfillment; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.store_fullfillment TO emanuel1;


--
-- Name: TABLE store_location; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.store_location TO emanuel1;


--
-- Name: TABLE store_report; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.store_report TO emanuel1;


--
-- Name: TABLE store_review; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.store_review TO emanuel1;


--
-- Name: TABLE store_sanction; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.store_sanction TO emanuel1;


--
-- Name: TABLE style_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.style_spec TO emanuel1;


--
-- Name: TABLE style_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.style_spec_product TO emanuel1;
...
GRANT ALL ON TABLE public.subscription TO emanuel1;


--
-- Name: TABLE subscription_duration; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.subscription_duration TO emanuel1;


--
-- Name: TABLE support_agent; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.support_agent TO emanuel1;


--
-- Name: TABLE table_list; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.table_list TO emanuel1;
...
GRANT ALL ON TABLE public.ticket TO emanuel1;


--
-- Name: TABLE ticket_discount_code; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.ticket_discount_code TO emanuel1;


--
-- Name: TABLE ticket_promo_code; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.ticket_promo_code TO emanuel1;


--
-- Name: TABLE ticket_transfer; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.ticket_transfer TO emanuel1;


--
-- Name: TABLE ticket_type; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.ticket_type TO emanuel1;


--
-- Name: TABLE topping_price; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.topping_price TO emanuel1;


--
-- Name: TABLE ubo_business_affiliation; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.ubo_business_affiliation TO emanuel1;


--
-- Name: TABLE ubo_verification_document; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.ubo_verification_document TO emanuel1;


--
-- Name: TABLE upc; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.upc TO emanuel1;
...
--
-- Name: TABLE user_event_category_like; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.user_event_category_like TO emanuel1;


--
-- Name: TABLE user_permission_entity; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.user_permission_entity TO emanuel1;
...
GRANT ALL ON TABLE public.user_roles TO emanuel1;


--
-- Name: TABLE user_size_pref; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.user_size_pref TO emanuel1;
...
GRANT ALL ON TABLE public.vehicle TO emanuel1;
...
GRANT ALL ON TABLE public.venue TO emanuel1;


--
-- Name: TABLE voltage_spec; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.voltage_spec TO emanuel1;


--
-- Name: TABLE voltage_spec_product; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.voltage_spec_product TO emanuel1;
...
GRANT ALL ON TABLE public.wishlist TO emanuel1;


--
-- Name: TABLE wishlist_item; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.wishlist_item TO emanuel1;


--
-- Name: TABLE wishlist_notification; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.wishlist_notification TO emanuel1;
